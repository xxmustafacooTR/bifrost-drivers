...
#if !MALI_USE_CSF
static void bv_r51p0_model_dump_prfcnt(void)
{
	unsigned long flags;
...
static void bv_r51p0_model_get_outputs(void *h)
{
...
static void bv_r51p0_model_update(void *h)
{
	struct dummy_model_t *dummy = (struct dummy_model_t *)h;
	u32 i;
...
void bv_r51p0_model_write_reg(void *h, u32 addr, u32 value)
{
	...
	bv_r51p0_model_update(dummy);
	bv_r51p0_model_get_outputs(dummy);
	spin_unlock_irqrestore(&hw_error_status.access_lock, flags);
}
