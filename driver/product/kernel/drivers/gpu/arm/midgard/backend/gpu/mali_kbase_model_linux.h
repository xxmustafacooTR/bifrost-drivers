 ...
 * @kbdev: Kbase device.
 *
 * Specific model hook is implemented by bv_r50p0_model_create()
 *
 ...
 * @kbdev: Kbase device.
 *
 * Specific model hook is implemented by bv_r50p0_model_destroy()
 */
void kbase_gpu_device_destroy(struct kbase_device *kbdev);

/**
 * bv_r50p0_model_create() - Private create function.
 *
 * @kbdev: Kbase device.
 *
 ...
 * Return: Model handle.
 */
void *bv_r50p0_model_create(struct kbase_device *kbdev);

/**
 * bv_r50p0_model_destroy() - Private destroy function.
 *
 * @h: Model handle.
 *
 * This hook is specific to the model built in Kbase.
 */
void bv_r50p0_model_destroy(void *h);

/**
 * bv_r50p0_model_write_reg() - Private model write function.
 *
 * @h: Model handle.
 ...
 * This hook is specific to the model built in Kbase.
 */
void bv_r50p0_model_write_reg(void *h, u32 addr, u32 value);

/**
 * bv_r50p0_model_read_reg() - Private model read function.
 *
 * @h: Model handle.
 ...
 * This hook is specific to the model built in Kbase.
 */
void bv_r50p0_model_read_reg(void *h, u32 addr, u32 *const value);
